 ...
 * @author Avinash
 */
public class TicTakToe_s extends javax.swing.JFrame {
    
    private String startGame="X";
    private int xCount=0;
    private int oCount=0;
    /**
     * Creates new form TicTakToe_s
     */
    public TicTakToe_s() {
        initComponents();
        setSize(1200,600);
...
private void choose_a_player()
{
   ...
   private void winningGame(){
       ...
       if(b1==("X") && b2==("X") && b3==("X")){
           JOptionPane.showMessageDialog(this,"Player X win","Tic Toc Toe",JOptionPane.INFORMATION_MESSAGE);
           xCount++;
           gameScore();
        ...
        if(b4==("X") && b5==("X") && b6==("X")){
         ...
         if(b1==("O") && b2==("O") && b3==("O")){
           JOptionPane.showMessageDialog(this,"Player O win","Tic Toc Toe",JOptionPane.INFORMATION_MESSAGE);
           oCount++;
           gameScore();
           jButton1.setBackground(Color.YELLOW);
           jButton2.setBackground(Color.YELLOW);
    ...
    private void initComponents() {
        ...
        jReset.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        ...
        jExit.setFont(new java.awt.Font("Tahoma", 1, 48)); // NOI18N
        jExit.setText("Exit");
...
private JFrame frame;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTakToe_s.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTakToe_s().setVisible(true);
            }
        });
    }
